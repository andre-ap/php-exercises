                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                ...
                                <a href="./" class="text-grey-300 hover:bg-gray-700 text-white rounded-md px-3 py-2 text-sm font-medium" aria-current="page">Home</a>
                                <a href="./about.php" class="bg-gray-900 text-gray-300 rounded-md px-3 py-2 text-sm font-medium">About Us</a>
